        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    XmlIdentifier = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RawBids", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RawBids_Areas_AreaId",
                        column: x => x.AreaId,
                        principalTable: "Areas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RawBids_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RawBids_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RawBids_AreaId",
                table: "RawBids",
                column: "AreaId");

            migrationBuilder.CreateIndex(
                name: "IX_RawBids_CompanyId",
                table: "RawBids",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_RawBids_UserId",
                table: "RawBids",
                column: "UserId");
        }
